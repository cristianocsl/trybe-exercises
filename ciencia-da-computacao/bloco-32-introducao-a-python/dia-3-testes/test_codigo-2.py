# get_most_ordered_dish_per_costumer é uma
# função que retorna o prato mais pedido por uma
# determinada pessoa cliente, considerando que os pedidos estão em uma lista.

# get_order_frequency_per_costumer é uma função
# que retorna a frequência que uma determinada
...
# novamente adicionamos um cenário (contexto) ao teste onde
# os pedidos realizados são os definidos na fixture
...
def test_get_order_frequency_per_costumer_when_customer_is_maria_and_order_is_hamburger(
    ...
    assert get_order_frequency_per_costumer(orders, "maria", "pizza") == 2
