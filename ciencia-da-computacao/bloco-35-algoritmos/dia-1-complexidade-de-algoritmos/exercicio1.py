...
# melhor caso: quando o número é encontrado na primeira posição.
# pior caso: qnd o número é encontrado na última posição.
# caso médio: qnd o número é encontrado na posição do meio.
