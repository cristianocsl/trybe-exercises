#  invocar um método a partir de uma classe, e não de uma instância dela.
...
class ZipCompressor(Serializer):
    ...
    def compress(csl, file_name):
        ...
        with ZipFile(csl.FILE_PATH + file_name + ".zip", "w") as zip_file:
...
# para testar:
relatorio_compras = SalesReportJSON("relatorio_fix7_")
relatorio_vendas = SalesReportJSON("relatorio_fix7_", ZipCompressor)
