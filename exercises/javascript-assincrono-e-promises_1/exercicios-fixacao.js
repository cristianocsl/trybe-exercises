...
const getCountry = (onSuccess) => {
  setTimeout(() => {
    ...
    if(didOperationSucceed) {
      ...
      const errorMessage = "Country could not be found"; // parte que já estava no código: frase que deve ser vista.
      printErrorMessage(errorMessage); // parte incluída: chama a função printErrorMessage e o parâmetro é a string errorMessage.
    }
  }, delay());
};
